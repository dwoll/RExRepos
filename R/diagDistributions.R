...
## ----rerDiagDistributions01----------------------------------------------
set.seed(123)
x <- rnorm(200, 175, 10)
hist(x, xlab="x", ylab="N", breaks="FD")

## ----rerDiagDistributions02----------------------------------------------

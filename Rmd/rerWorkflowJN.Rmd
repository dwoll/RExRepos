...
This website is currently (2020) built with [nanoc](http://nanoc.ws/) (version 4.11.0, compatibility options for working with nanoc3 config), using Ruby (version 2.7.0). The design uses the [Bootstrap framework](https://getbootstrap.com/) (version 3.3.0). As a markdown engine, I use pandoc (version 2.5) because it provides
...
Setup for Hugo using package `blogdown`
-------------------------

`knitr`-based online publication is supported by the R package [blogdown](https://github.com/rstudio/blogdown/) which supports [Hugo](https://gohugo.io).

...
[`Hmisc`](https://cran.r-project.org/package=Hmisc), [`mvtnorm`](https://cran.r-project.org/package=mvtnorm), [`plotrix`](https://cran.r-project.org/package=plotrix)
...
See packages [`EBImage`](http://www.bioconductor.org/packages/release/bioc/html/EBImage.html) or [`adimpro`](https://cran.r-project.org/package=adimpro) to read in image files of various formats.

...
See packages [`imager`](https://cran.r-project.org/package=imager) or [`adimpro`](https://cran.r-project.org/package=adimpro) to read in image files of various formats.

...
-------------------------
 ...
 - Package [`colorspace`](https://cran.r-project.org/package=colorspace) provides more functions for converting between different color spaces. Its [documentation](http://colorspace.r-forge.r-project.org/) illustrates many color palettes for different use cases.

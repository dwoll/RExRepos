...
By default, `lmer()` does not calculate p-values since the package authors [see no convincing justification for selecting a particular value for the denominator (error) degrees of freedom](https://stat.ethz.ch/pipermail/r-help/2006-May/094765.html).

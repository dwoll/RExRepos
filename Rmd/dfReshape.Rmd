...
Package [`tidyr`](http://cran.r-project.org/package=tidyr) provides functions `pivot_longer()` and `pivot_wider()` for an alternative approach to reshaping data frames that can be integrated into a [`dplyr`](https://dplyr.tidyverse.org/) based workflow.

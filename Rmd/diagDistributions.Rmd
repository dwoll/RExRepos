...
[`car`](https://cran.r-project.org/package=car), [`hexbin`](https://cran.r-project.org/package=hexbin), [`beeswarm`](https://cran.r-project.org/package=beeswarm)
...
To compare the histograms from two groups, see `histbackback()` from package [`Hmisc`](https://cran.r-project.org/package=Hmisc).

...
[`lmtest`](https://cran.r-project.org/package=lmtest), [`MASS`](https://cran.r-project.org/package=MASS), [`mvtnorm`](https://cran.r-project.org/package=mvtnorm), [`pscl`](https://cran.r-project.org/package=pscl), [`sandwich`](https://cran.r-project.org/package=sandwich), [`VGAM`](https://cran.r-project.org/package=VGAM)

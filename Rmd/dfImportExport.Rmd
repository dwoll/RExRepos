...
[`foreign`](https://cran.r-project.org/package=foreign), [`RSQLite`](https://cran.r-project.org/package=RSQLite)

```{r}
wants <- c("foreign", "RSQLite")
...
To read and write Excel files directly, use package [`XLConnect`](https://cran.r-project.org/package=XLConnect).
